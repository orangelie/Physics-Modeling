...
#include "HEADER/PUBLIC/Engine/ZekrosEnginePacked.h"

namespace orangelie {

	namespace Engine {

		ZekrosEnginePacked::ZekrosEnginePacked() {
		}

		ZekrosEnginePacked::~ZekrosEnginePacked() {
		}

		void ZekrosEnginePacked::LoadTextures() {
			m_TextureLoader.AddTexture("whiteb", L"./Textures/StoneBlock.dds", m_Device, m_CommandList.Get());
		}

		void ZekrosEnginePacked::BuildRootSignature() {
		...
		void ZekrosEnginePacked::BuildDescriptorHeap() {
		...
		void ZekrosEnginePacked::BuildShaderSystem() {
		...
		void ZekrosEnginePacked::BuildGridGeometry() {
		...
		void ZekrosEnginePacked::BuildBoxGeometry() {
			orangelie::Mesh::GeometryGenerator geoGen;
		...
		void ZekrosEnginePacked::BuildFontEngine() {
		...
		void ZekrosEnginePacked::BuildMaterials() {
		...
		void ZekrosEnginePacked::BuildRenderItems() {
		...
		void ZekrosEnginePacked::BuildFrameResources() {
		...
		void ZekrosEnginePacked::BuildPSOs() {
		...
		void ZekrosEnginePacked::DrawRenderItems(std::vector<orangelie::Rendering::RenderItem*> rItems) {
		...
		void ZekrosEnginePacked::AnimateMaterialBuffer(float dt) {
		...
		void ZekrosEnginePacked::UpdateObjectCBs() {
		...
		void ZekrosEnginePacked::UpdatePassCBs() {
		...
		void ZekrosEnginePacked::UpdateMatVBs() {
		...
		void ZekrosEnginePacked::OnKeyboardInput(float dt) {
		...
		void ZekrosEnginePacked::OnResize() {
		...
		void ZekrosEnginePacked::update(float dt) {
			OnKeyboardInput(dt);
		...
		void ZekrosEnginePacked::draw(float dt) {
		...
		void ZekrosEnginePacked::MouseDown(WPARAM btnState, int x, int y) {
			m_LastPrevPoint.x = x;
			m_LastPrevPoint.y = y;
		...
		void ZekrosEnginePacked::MouseUp(WPARAM btnState, int x, int y) {
			ReleaseCapture();
		}

		void ZekrosEnginePacked::MouseMove(WPARAM btnState, int x, int y) {
